...
function Bubble()
{
    ...
    for(var i=0;i<array_size-1;i++)
    {
        ...
        div_update(divs[j],div_sizes[j], "#1ABC9C");//Color update
    }
    div_update(divs[0],div_sizes[0], "#1ABC9C");//Color update
...
function Selection_sort()
{
    ...
    for(var i=0;i<array_size-1;i++)
    {
        ...
        div_update(divs[i],div_sizes[i],"#1ABC9C");//Color update
    }
    div_update(divs[i],div_sizes[i],"#1ABC9C");//Color update
...
function Insertion()
{
    ...
    for(var j=0;j<array_size;j++)
    {
        ...
        for(var t=0;t<j;t++)
        {
            div_update(divs[t],div_sizes[t],"#1ABC9C");//Color update
        }
    }
    div_update(divs[j-1],div_sizes[j-1],"#1ABC9C");//Color update
...
function merge_sort(start,mid,end)
{
    ...
    for(var t=0;t<k;t++)
    {
        ...
        div_update(divs[start-1],div_sizes[start-1],"#1ABC9C");//Color update
    }
}
